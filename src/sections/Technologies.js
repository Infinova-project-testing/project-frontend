      ...
      <div className="container">
        ...
        <div className="cards-grid" style={{display:"flex",justifyContent:"center"}}>
          <div className="card" style={{maxWidth:"20rem"}}>
            <div className="card-icon"><img src="./assets/image/3d.png" alt="" width={90} /></div>
            ...
            <button disabled href="#" style={{cursor:"not-allowed"}} className="card-button">Coming Soon!!</button>
          </div>
          <div className="card" style={{maxWidth:"20rem"}}>
            <div className="card-icon"><img src="./assets/image/emerging.png" alt="" width={90} /></div>
            <h3>Emerging Technologies</h3>
            <p>Stay tuned for our upcoming innovative technology solutions that will revolutionize industries.</p>
            <button disabled href="#" style={{cursor:"not-allowed"}} className="card-button">Coming Soon!!</button>
          </div>
          <div className="card" style={{maxWidth:"20rem"}}>
            <div className="card-icon"><img src="./assets/image/innovation.png" alt="" width={90} /></div>
